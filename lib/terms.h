...
class LIB_SYREM_EXPORT TimeTerm : public SubTerm
{
	Q_OBJECT
...
class LIB_SYREM_EXPORT DateTerm : public SubTerm
{
	Q_OBJECT
...
class LIB_SYREM_EXPORT InvertedTimeTerm : public SubTerm
{
	Q_OBJECT
	Q_PROPERTY(QTime time MEMBER _time)
...
class LIB_SYREM_EXPORT MonthDayTerm : public SubTerm
{
	Q_OBJECT
...
class LIB_SYREM_EXPORT KeywordTerm : public SubTerm
{
	Q_OBJECT
...
class LIB_SYREM_EXPORT LimiterTerm : public SubTerm
{
	Q_OBJECT
	// not stored...
...
LIB_SYREM_EXPORT QString trWord(WordKey key, bool escape = true);
LIB_SYREM_EXPORT QStringList trList(WordKey key, bool escape = true, bool sort = true);

LIB_SYREM_EXPORT QString dateTimeFormatToRegex(QString pattern, const std::function<void(QString&)> &replacer);
