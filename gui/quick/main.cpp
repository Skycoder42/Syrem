...
int main(int argc, char *argv[])
{
	...
	qmlRegisterUncreatableType<SnoozeTimes>("de.skycoder42.syrem", 1, 0, "SnoozeTimes", QStringLiteral("Q_GADGETs cannot be created!"));
	QMLTYPE_SyncedSettings::registerQmlTypes("de.skycoder42.syrem", 1, 0);
	qmlRegisterSingletonType<SnoozeTimesGenerator>("de.skycoder42.syrem", 1, 0, "SnoozeTimesGenerator", create_snooze_times_generator);
	qmlRegisterUncreatableType<Reminder>("de.skycoder42.syrem", 1, 0, "Reminder", QStringLiteral("Q_GADGETs cannot be created!"));
	qmlRegisterUncreatableType<MainViewModel>("de.skycoder42.syrem", 1, 0, "MainViewModel", QStringLiteral("ViewModels cannot be created!"));
	qmlRegisterUncreatableType<CreateReminderViewModel>("de.skycoder42.syrem", 1, 0, "CreateReminderViewModel", QStringLiteral("ViewModels cannot be created!"));
	qmlRegisterUncreatableType<SnoozeViewModel>("de.skycoder42.syrem", 1, 0, "SnoozeViewModel", QStringLiteral("ViewModels cannot be created!"));
	qmlRegisterUncreatableType<TermSelectionViewModel>("de.skycoder42.syrem", 1, 0, "TermSelectionViewModel", QStringLiteral("ViewModels cannot be created!"));
